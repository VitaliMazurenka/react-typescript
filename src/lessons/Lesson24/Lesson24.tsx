...
function Lesson24() {
  ...
  useEffect(() => {
    ...
    // Например: мы вводим что-то с клавиатуры и на каждый введенный символ, следим за обновлением
    // компонента и отправляем запрос на бэкенд для получения совпадений с введенными вами символами
    // проимером может быть поиск людей в facebook при совпадении имени
